  ...
  return (
    <section id="menu-section" className="relative py-2 sm:py-4 lg:py-4 bg-transparent">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-[#f6e975] to-[#f8e29e] rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>

        <div className="absolute top-40 left-1/2 w-80 h-80 bg-gradient-to-br from-[#efe490] to-[#fdfdfd] rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
      </div>
        ...
        {categories.map((category) => {
          ...
          return (
            <div key={category} className="space-y-3 sm:space-y-4 lg:space-y-6">
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold  px-2 sm:px-2">{category}</h3>
              ...
              <div className="overflow-x-auto pb-4">
                <div className="flex space-x-3 sm:space-x-4 lg:space-x-6 px-2 " style={{ width: "max-content" }}>
                  {categoryItems.map((item) => (
                    <div
                      key={item.id}
                      className="glare-card backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 flex-shrink-0 w-64 sm:w-72 lg:w-80 bg-white/20"
                    >
                      {/* 3D Model Display - Increased height */}

                      <div className="h-80 w-80  sm:h-64 lg:h-72 bg-transparent relative">
                      ...
                      <div className="p-2 sm:p-3 lg:p-4">
                        ...
                        <div className="mb-2 sm:mb-3">
                          ...
                          <p className="text-xs text-gray-600 line-clamp-1">{item.ingredients.join(", ")}</p>
                        </div>
